...
// FontFile is the path to font file
...
// BackgroundColor is the output file background color
...
// MaskBoxes is a list of bounding boxes where words can not be placed.
// See Mask
...
// RandomPlacement places words randomly
...
// Debug draws bounding boxes around words
func Debug() Option {
	return func(options *Options) {
		options.Debug = true
	}
...
// NewWordcloud initializes a wordcloud based on a map of word frequency.
